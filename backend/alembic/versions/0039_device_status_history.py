...
def downgrade():
    drop_index_if_exists("ix_device_status_history_changed_at", table_name="device_status_history")
    drop_index_if_exists("ix_device_status_history_device_id", table_name="device_status_history")
