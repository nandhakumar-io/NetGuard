...
export default function FirmwareUpgradesPage() {
  ...
  const exportCsv = () => {
    downloadCsv(
      `netguard-firmware-upgrades-${todayStamp()}.csv`,
      toCsv(jobs, [
        { header: "Device", value: (r) => deviceHostname(r.device_id) },
        { header: "From Version", value: (r) => r.from_version || "" },
        { header: "Target Version", value: (r) => r.target_version },
        { header: "Status", value: (r) => r.status },
        { header: "Attempts", value: (r) => r.attempts },
        { header: "Error", value: (r) => r.error_message || "" },
        { header: "Initiated By", value: (r) => r.initiated_by },
        { header: "Scheduled At", value: (r) => (r.scheduled_at ? new Date(r.scheduled_at).toISOString() : "") },
        { header: "Started At", value: (r) => (r.started_at ? new Date(r.started_at).toISOString() : "") },
        { header: "Completed At", value: (r) => (r.completed_at ? new Date(r.completed_at).toISOString() : "") },
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button onClick={exportCsv} disabled={jobs.length === 0} className={`${exportButtonClass} disabled:opacity-40`}>
